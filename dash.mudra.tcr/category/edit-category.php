...
<div class="mb-3">
                          ...
                          <input type="text" value="<?php echo $userArr[0]->name ?>" class="form-control" id="catname" name="catname" placeholder="Category Name" required>
                        </div>
                        <!-- <div class="mb-3">
                ...
                <button type="submit" name="catBTN" id="catBTN" class="btn btn-primary">Save</button><?php }
                                                                                                      ?>
                    </form>
                      <script>
