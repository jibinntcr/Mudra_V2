...
if (strlen($_SESSION['alogin']) == 0) {
  ...
  if (isset($_POST['catBTN'])) {
    ...
    $status = '1';
    $sql = "INSERT INTO category(name,slug,status) VALUES ('" . $category . "','" . $slug . "','" . $status . "')";
    // print_r($sql);
    // exit();
...
>
  <head>
    ...
    <title>Create New Category | Mudra Publications</title>
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <span class="text-muted fw-light">Admin / </span>Create New Category</h4>
