...
if (strlen($_SESSION['alogin']) == 0) {
  ...
  if (isset($_POST['fileBTN'])) {
    ...
    $status = '1';
    $sql = "INSERT INTO files(name,nameML,filenumber,slug,category,rsubcategory,date,premium,image,status,content) VALUES (:filenameEn,'" . $filenameML . "','" . $fileNumber . "','" . $slug . "','" . $category . "','" . $subcategory . "','" . $date . "','" . $premium . "','" . $image . "','" . $status . "','" . $content . "')";
    // print_r($sql);
    // exit();
...
>
  <head>
    ...
    <title>Create New File | Mudra Publications</title>
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <span class="text-muted fw-light">Admin / </span>Create New File</h4>
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="filenameEn" name="filenameEn" placeholder="File Name In English" required>
                    </div>
                    
                    <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">File Name in Malayalam</label>
                          <input type="text" class="form-control" id="filenameMl" name="filenameMl" placeholder="File Name in Malayalam" required>
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <button type="submit" name="fileBTN" id="fileBTN" class="btn btn-primary">Save</button>
                    </form>
                    <script>
